        ...
        <div class="col-md-12">
            ...
            <div class="container">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <input type="hidden" class="form-control disabled" name="parent_id" value="<?php echo $row['id']; ?>" placeholder="Enter main item ">
                    <div class="form-row form-group">
                        <label class="col-sm-2 col-form-label">Image</label>
                        <label class="col-form-label">:</label>
                        <div class="col">
                            <input type="file" name="image" id="fileToUpload" class="form-control" placeholder="Image">
                        </div>
                        <label class="col-sm-2 col-form-label">Name</label>
                        <label class="col-form-label">:</label>
                        <div class="col">
                            <input type="text" class="form-control" value="<?php echo $row['item_name']; ?>" name="name" placeholder="Enter sub item ">
                        </div>
                    </div>
                    ...
                    <div class="form-row form-group">
                        ...
                        <label class="col-form-label">:</label>
                        <div class="col">
                            <select name="unit_name" class="form-control" id="unit_name">
                                <?php
                        ...
                        <div class="col">
                            ...
                            <input type="hidden" class="form-control" value="<?php echo $row['item_category']; ?>" name="item_category" placeholder="Enter sub item ">
                        </div>
                    </div>
                    <div class="form-row form-group">
                        ...
                        <label class="col-form-label">:</label>
                        <div class="col">
                            <input type="text" class="form-control" name="item_code" value="<?php echo $row['item_code']; ?>" placeholder="Enter main item ">
                        </div>
                    ...
                    <div class="form-row form-group">
                        ...
                        <label class="col-form-label">:</label>
                        <div class="col">
                            <input type="text" class="form-control" name="sellable_option" value="<?php echo $row['sellable_option']; ?>" placeholder="Enter main item ">
                        </div>
                    </div>
                    ...
                    <div class="form-row form-group">
                        ...
                        <label class="col-form-label">:</label>
                        <div class="col">
                            <input type="text" class="form-control" name="texable_option" value="<?php echo $row['texable_option']; ?>" placeholder="Enter main item ">
                        </div>
                        <label class="col-sm-2 col-form-label">Pack Size</label>
                        <label class="col-form-label">:</label>
                        <div class="col">
                            <input type="text" class="form-control" name="pack_size" value="<?php echo $row['pack_size']; ?>" placeholder="Enter main item ">
                        </div>
                    </div>
                    <div class="form-row form-group">
