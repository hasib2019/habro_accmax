        ...
        <div>
            <h1>
                <div class="w3-bar w3-black">
                    <button class="w3-bar-item w3-button" onclick="memberProfile('profile')">member Profile</button>
                    <button class="w3-bar-item w3-button" onclick="memberProfile('setting')">Setting</button>
