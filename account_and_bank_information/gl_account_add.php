    ...
    <div class="col-md-12">
      ...
      <form action="" method="post">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6" >
            <input type="radio" name="postable_acc" selected value="Y" onclick="Fun()" id="more"><label class="col-sm-3 col-form-label">Ledger Account</label>
            <input type="radio" name="postable_acc" value="N" id="" class="group"><label class="col-sm-3 col-form-label">Group Account</label>
          </div>
        </div>
          <!-- ====== more information start ====== -->
          <div <?php if ($_SESSION['seprt_cs_info'] !== 'Y'){echo 'id="more_show"';} else{ echo 'id="not"'.  'style="display: none"'; }?> >
            <!-- address -->
            <div class="form-group row">
