        ...
        <div>
            <h1>
                <div class="w3-bar w3-black">
                    <button class="w3-bar-item w3-button" onclick="supplierProfile('profile')">supplier Profile</button>
                    <button class="w3-bar-item w3-button" onclick="supplierProfile('setting')">Setting</button>
