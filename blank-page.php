                    ...
                    <div class="row">
                      <div class="col-md-8">
                        <div style="border:1px solid #d1d1d1; padding:10px; background-color: #f0efef99;">
                          <h2 style="background-color: #dbdbdb; padding: 10px 10px 10px 10px;">Personal Information</h2>
                          <hr>
                          <div class="row">
                            <div class="col-md-6">
                      ...
                      <div class="col-md-4 text-center">
                        <div style="border:1px solid #d1d1d1; padding:10px; background-color: #f0efef99;">
                          <h2 style="background-color: #dbdbdb;padding: 10px 10px 10px 10px;">Student's Photo</h2>
                          <div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div style="border:1px solid #d1d1d1;padding:10px; background-color: #f0efef99; margin-top:20px;">
                          <div class="row">
                            <div class="col-md-12">
                              <h2 style="background-color: #dbdbdb; padding: 10px 10px 10px 10px;">Course Information</h2>
                            </div>
                          </div>
                          <hr>
